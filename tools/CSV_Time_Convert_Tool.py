...
class App(tkinter.Frame):
    ...
    def on_closing():
        ...
        with open(conf_geometry, "w") as conf:
...
window = tkinter.Tk()
button1 = tkinter.Button(window,text='Batch select csv files',command=App.select_file)
button2 = tkinter.Button(window,text='Read the csv file',command=App.read_file)
...
try:
    with open(conf_geometry, "r") as conf: 
