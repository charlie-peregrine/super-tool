...
class SuperToolMain:
    def __init__(self, parent):
        ...
        main_frame = ttk.Frame(self.parent, height=600, width=600)
        ...
        ttk.Button(test_frame, image=self.img, command=run_simulation).grid(row=0, column=2)
