...
dyd_filename    =  "U1.dyd"
sav_filename    =  "02_U1_CI.sav"
chf_filename    =  "02_U1_CI_sim_v23.chf"
csv_filename    =  "02_U1_CI_sim_v23.csv"
rep_filename    =  "Rep.rep"

tripTimeInSecs  =   2.0
totTimeInSec    =   36
PSS_On          =   0             # 0:disable PSS model, 1: enable PSS model */
change_Pref     =   1             # 1:Change Pref after breaker opens, 0: no change */
offline_Pref    =   0.004         # note GGOV model uses 1 as base offline while HYG3 and IEEE1 use 0 */
change_Vref     =   0             # 1:Change Vref after breaker opens, 0: no change */
offline_Vref    =   0.79
AVR_On          =   0             # 0: Exciter in Manual, 1: Exciter in Auto */
